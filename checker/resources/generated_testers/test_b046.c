...
int		main(void)
{
	...
	printf_ = fopen("../testing_results/test_b046_printf_print", "w");
	printf_ret = fopen("../testing_results/test_b046_printf_ret", "w");
	ft_printf_ret = fopen("../testing_results/test_b046_ft_printf_ret", "w");
