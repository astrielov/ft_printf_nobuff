...
int		main(void)
{
	...
	printf_ = fopen("../testing_results/test_b059_printf_print", "w");
	printf_ret = fopen("../testing_results/test_b059_printf_ret", "w");
	ft_printf_ret = fopen("../testing_results/test_b059_ft_printf_ret", "w");
...
//@
	...
	if (ret1 == -1) {printf_ = fopen("../testing_results/test_b059_printf_print", "a"); setvbuf(printf_, NULL, _IONBF, 0);}
//@
	ft_printf("\n#0001");
	fprintf(printf_, "\n#0001");
	ret1 = fprintf(printf_, "|%10.F|", 1024.00445);
