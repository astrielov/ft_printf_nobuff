...
int		main(void)
{
	...
	printf_ = fopen("../testing_results/test_m035_printf_print", "w");
	printf_ret = fopen("../testing_results/test_m035_printf_ret", "w");
	ft_printf_ret = fopen("../testing_results/test_m035_ft_printf_ret", "w");
...
//@
	...
	if (ret1 == -1) {printf_ = fopen("../testing_results/test_m035_printf_print", "a"); setvbuf(printf_, NULL, _IONBF, 0);}
//@
	ft_printf("\n#0001");
	fprintf(printf_, "\n#0001");
